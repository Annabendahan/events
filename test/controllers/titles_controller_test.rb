...
class TitlesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create title" do
    assert_difference('Title.count') do
      post titles_url, params: { title: { address: @title.address, description: @title.description, lat: @title.lat, lng: @title.lng, photo: @title.photo, user_id: @title.user_id } }
    end
  ...
  test "should update title" do
    patch title_url(@title), params: { title: { address: @title.address, description: @title.description, lat: @title.lat, lng: @title.lng, photo: @title.photo, user_id: @title.user_id } }
